...
class JeninsDeploy(object):
    ...
    def formatResultStr(self,data, appname):
        ...
        if data:
            ...
            newstr = resultJobInfo.replace("/job", "/jenkins/blue/organizations/jenkins")
            return newstr
        else:
            return  '''http://192.168.11.101/jenkins/blue/organizations/jenkins/{appName}/detail/{JobName}/1/pipeline'''.format(appName=appname,JobName=appname)
